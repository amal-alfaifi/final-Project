...
class NewAttendant: UIViewController, UITextFieldDelegate {
    ...
    @objc func add() {
        ...
        AttendantService.shared.addAttendant(attendant: AttendantModel(name: name, id: id, age: age, num: num, hospitalName: hospitalName, userID: token!))
                        ...
                        for doc in snapshotDocuments {
                               ...
                               let userEmail = data["email"] as? String
                            {
                                DispatchQueue.main.async {
                                    self.attendantNameTF.text = data["name"] as? String
                                    self.attendantIdTF.text = data["ID"] as? String
                                    self.attendantNumTF.text = data["phone"] as? String
                                    self.ageTF.text = data["age"] as? String
                                }}}}}}
    }
